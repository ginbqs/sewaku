...
$(document).ready(function () {
	...
	$("#menu_access_management_operator").addClass('active');
  table_master_user = $("#manage_all").DataTable({
    processing: true,
    serverSide: true,
...
function reload_table() {
    table_master_user.ajax.reload(null, false); //reload datatable ajax
}
function create(){
  $("#modal_data").empty();
