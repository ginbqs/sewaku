<form role="form" id="edit"   enctype="multipart/form-data" method="post" accept-charset="utf-8">
  ...
  <div class="card-body">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="input_id" placeholder="ID" name="input_id" value="{{$configurasi->id}}">
      <span id="error_input_id" class="error invalid-feedback"></span>
    </div>
    <div class="form-group">
      <label for="input_value">Nama</label>
      <input type="text" class="form-control capitalize" id="input_value" placeholder="Nama" name="input_value" value="{{$configurasi->value}}">
