...
<head>
  ...
  <title>@yield('title') | {{ isset($app_settings) ? $app_settings->name : config('app.name') }}</title>
...
<div class="wrapper">
  <!-- Navbar -->
  @include('bqs.layouts.header')
  <!-- /.navbar -->

  <!-- Main Sidebar Container -->
  @include('bqs.layouts.sidebar')
